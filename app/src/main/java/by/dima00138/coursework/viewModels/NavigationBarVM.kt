...
sealed class Screen(val route: String, @StringRes val resourceId: Int,@DrawableRes val icon: Int) {
    object Search : Screen("Search", R.string.search, R.drawable.search_icon)
    object Board : Screen("board", R.string.board, R.drawable.board_icon)
    object Orders : Screen("orders", R.string.orders, R.drawable.orders_icon)
    object Profile : Screen("profile", R.string.profile,R.drawable.profile_icon )
    object More : Screen("more", R.string.more, R.drawable.more_icon)
}
